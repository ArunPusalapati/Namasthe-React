...
const RestoCard=(props)=>{
    ...
    return (
        ...
        <img className="resto-logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" +cloudinaryImageId}/>
        <h3>{name}</h3>
        <h4>{cuisines.join(",")}</h4>
        <h4>{costForTwo}</h4>
...
//       "cloudinaryImageId": "RX_THUMBNAIL/IMAGES/VENDOR/2025/5/9/f3e84665-f366-4dff-8351-fe9f139baa2c_581695.jpg",
//       "locality": "Vithalwadi",
